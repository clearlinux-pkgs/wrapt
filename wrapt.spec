...
%prep
%setup -q -n wrapt-1.12.1
cd %{_builddir}/wrapt-1.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619124281
...
cp %{_builddir}/wrapt-1.12.1/LICENSE %{buildroot}/usr/share/package-licenses/wrapt/a33869ea84bae0e6f673c38a1fb27c9b90610249
